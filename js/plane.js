...
// 	gameCon.style.top = bgObj1.offsetTop + 1 + "px";
// 	//判断背景图片是否全部滚动出去，如果全部滚动出去，则让他跳到最上面
// 	if (bgObj1.offsetTop >= 568) {
// 		bgObj1.style.top = -568 + "px";
// 		console.log(1);
// 	}
// 	//判断背景图片是否全部滚动出去，如果全部滚动出去，则让他跳到最上面
// 	if (bgObj2.offsetTop >= 568) {
// 		bgObj2.style.top = -568 + "px";
// 	}
// }, 20);
